...
<div class="sub_link_box">
	<div class="sub_link_menu">
		<span id="sub_Color_f"><a href="/mall">포인트몰</a></span>
		<%-- <c:if test="${session_userid =='admin' }"> --%>
		<span id="sub_Color_f"  class="sub_under_bar"><a href="./mall_writeView">물품 등록 페이지</a></span>
		<%-- </c:if> --%>
    </div>
</div>
<div id="contain02">
...
<div id="online_write_wrap">    
	<form name="online_write_box" id="online_write_box" method="post" action="./mall_write" enctype="multipart/form-data">
	...
	<div class="online_Awrite_form">
		<ul>
            ...
            <li class="box_li">
				<span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;포인트</span>
                <div class="value">
                <input type="number" name="point" id="point" class="online_write_input02" style="width:100px;" >
                </div>
            </li>
            <li class="box_li" >
        	  ...
        	  <li class="online_wirte_editor" style="clear:both;">
				<span class="online_write_title02" style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;상품상세 내용</span>
                <div class="value">
    ...
    <div class="online_write_button">
		<span class="online_center">
			<span class="button_pack">
                ...
                <span class="btn_input"><button type="button" class="online_lg_color02" id="link_btn" style="cursor:pointer;font-family: NanumBarunGothic;">이전으로</button></span>
            </span>
        </span>
     </div>
</form>
