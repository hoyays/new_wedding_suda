...
<div id="online_write_wrap">    
	<form name="online_write_box" id="online_write_box" method="post" action="./event_modify" enctype="multipart/form-data">
	  <input type="hidden" name="userid" id="userid" value="${map.eventDto.userid }">
      <input type="hidden" name="bid" value="${map.eventDto.bid }">
      <input type="hidden" name="fileName" value="${map.eventDto.fileName }">
	<div class="online_Awrite_form">
		<ul>
			<li class="box_li">
				<span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;제목</span>
                <div class="value">
                <input type="text" name="btitle" id="title" class="online_write_input" value="${map.eventDto.btitle }" style="padding-left:5px;color:#000000;">
                </div>
            </li>                
            <li class="box_li">
				<span class="online_write_title"><img  src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;${map.eventDto.nickname }</span>
                <div class="value">
                <input type="text" name="nname" id="name" class="online_write_input02" value="${map.eventDto.nickname }" style="padding-left:5px;color:#000000;">
                </div>
            </li>
            <li class="box_li" >
        	  ...
        	  <li class="online_wirte_editor" style="clear:both;">
                ...
                <div class="value">
                <div><textarea name="bcontent" id="content" >${fn:replace(map.eventDto.bcontent,br,cn)}</textarea></div>
                </div>
            </li>
          	<li class="online_wirte_editor" style="clear:both;">
				<span class="online_write_title03" scale-down style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;이미지</span>
				<div class="value" style="margin-left: 10px; margin-top: 10px" >
				<img alt="" src="/upload/${map.eventDto.fileName}"   style="object-fit: scale-down">
				</div>
            </li>
