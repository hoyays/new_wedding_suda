...
<div id="online_write_wrap">    
	<form name="online_write_box" id="online_write_box" method="post" action="./event_write" enctype="multipart/form-data">
	...
	<div class="online_Awrite_form">
		<ul>
            ...
            <li class="box_li">
                ...
                <div class="value">
                <input type="text" name="nickname" id="nickname" class="online_write_input02" value="${session_nickName }" style="padding-left:5px;color:#000000;" readonly="readonly">
                </div>
            </li>
            <li class="box_li" >
