...
<div id="online_write_wrap">    
	<form name="online_write_box" id="online_write_box" method="post" action="./after_modify" enctype="multipart/form-data">
	  <input type="hidden" name="userid" id="userid" value="${map.userid }">
	  <input type="hidden" name="page" value="${map.page }">
      <input type="hidden" name="bid" value="${map.afterDto.bid }">
      <input type="hidden" name="category" value="${map.category }">
      <input type="hidden" name="search" value="${map.search}">
      <input type="hidden" name="fileName" value="${map.afterDto.fileName }">
	<div class="online_Awrite_form">
		<ul>
			<li class="box_li">
				<span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;제목</span>
                <div class="value">
                <input type="text" name="btitle" id="title" class="online_write_input" value="${map.afterDto.btitle }" style="padding-left:5px;color:#000000;">
                </div>
            </li>                
            <li class="box_li">
				<span class="online_write_title"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;이름</span>
                <div class="value">
                <input type="text" name="nname" id="name" class="online_write_input02" value="${map.afterDto.nname }" style="padding-left:5px;color:#000000;">
                </div>
            </li>
            <li class="box_li" >
        	  ...
        	  <li class="online_wirte_editor" style="clear:both;">
                ...
                <div class="value">
                <div><textarea name="bcontent" id="content" >${fn:replace(map.afterDto.bcontent,br,cn)}</textarea></div>
                </div>
            </li>
          	<li class="online_wirte_editor" style="clear:both;">
				<span class="online_write_title03" style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;이미지</span>
				<div class="value" style="margin-left: 10px; margin-top: 10px" >
				<img alt="" src="/upload/${map.afterDto.fileName}"   style="object-fit: cover;">
				</div>
            </li>
