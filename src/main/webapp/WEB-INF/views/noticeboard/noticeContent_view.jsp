...
.jssora22r.jssora22rdn {
	background-position: -310px -31px
		...
		<div id="jssor_1"
			style="position: relative; margin: 0px auto; top: 0px; left: 0px; width: 1348px; height: 230.508px; overflow: hidden; visibility: visible;"
			jssor-slider="true">
			...
			<div
				style="position: absolute; top: 0px; left: 0px; width: 2000px; height: 342px; transform-origin: 0px 0px; transform: scale(0.674);">
				<div class=""
					...
					<div class="imgs" data-u="slides"
						...
						<div style="position: absolute; z-index: 0; pointer-events: none;"></div>
					</div>
					<div class="imgs" data-u="slides"
						style="cursor: default; position: absolute; top: 0px; left: 0px; width: 2000px; height: 342px; overflow: hidden; z-index: 0;">
						<div
						...
						<div class="sub_link_menu_wrap"
							...
							<img class="bg_img" data-u="image" src="../images/story.jpg
		"
								border="0"
		...
		<div id="contain02">
			<div id="contain02_text">
				<span class="title_name">공지사항</span> <span class="title_detail">결혼
					준비의 새로운 기준 웨딩수다와 함께 하세요!</span>
			</div>
		</div>
		<div id="event_detail_wrap">
			<div id="event_detail_title">
				<span class="event_title_txt">${map.noticeDto.btitle }</span>
			</div>
			<div id="after_detail_date">
				<span id="after_detail_date_day"
					style="font-size: 13px; color: #000000;">• 작성일</span> <span
					class="after_detail_date_day" style="font-size: 13px;">${map.noticeDto.bdate }</span>

			</div>
			<div id="after_detail_img" style="font-size: 14px;">
				${map.noticeDto.bcontent }
			
				<br>			
				<img alt="" src="/upload/${map.noticeDto.fileName }" > 
			</div>

			<div id="after_detail_lotation">
				<div id="after_lotation_left">
					<div class="after_lotation_left01">
						<a><img src="../images/up.jpg" alt="up">이전글</a>
					</div>
					<div class="after_lotation_left02">
						<a href="./noticeContent_view?category=${map.category }&search=${map.search }&page=${map.page}&bid=${map.nextDto.bid }">${map.nextDto.btitle }</a>

					</div>
				</div>
				<div id="after_lotation_right">
					<div class="after_lotation_right01">
						<a><img src="../images/down.jpg" alt="down">다음글</a>
					</div>
					<div class="after_lotation_right02">
						<a href="./noticeContent_view?category=${map.category }&search=${map.search }&page=${map.page}&bid=${map.preDto.bid }">${map.preDto.btitle }</a>

					</div>
				</div>
			</div>
			<div id="event_return">
				<span class="event_return_txt"><a
					href="notice_list?category=${map.category }&search=${map.search }&page=${map.page}">목록으로</a></span>
			</div>
		</div>
