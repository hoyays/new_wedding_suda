...
$(document).ready(function() {	
	...
	$('#link_btn').click(function() {
		data = $(this).attr("data");
		top.location.href="./notice_list";
	});
});

</script>
<div id="online_write_wrap">    
	<form name="online_write_box" id="online_write_box" method="post" action="./notice_write" enctype="multipart/form-data">
	<div class="online_Awrite_form">
		<ul>
			<li class="box_li">
				<span class="online_write_title" style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;제목</span>
                <div class="value"><input type="text" name="btitle" id="title" class="online_write_input" value="" style="color:#000000;background-color:#ffffff;padding-left:5px;"></div>
            </li>                
            <li class="ess double">
				<span class="online_write_title" style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;글쓴이</span>
                <div class="value02"><input type="text" name="id" id="name" class="online_write_input02" value="admin" style="width:150px;color:#000000;background-color:#ffffff;padding-left:5px;" readonly="readonly"></div>
            </li>	
            <li class="ess double">
				<span class="online_write_title" style="font-size:14px;"><img src="../images/member_icon.png">&nbsp;&nbsp;&nbsp;파일첨가</span>
                <div class="value_radio">
                <input type="file" name="file" id="file" style="margin-top: 12px;">
            	</div>
            </li>
            <li class="online_wirte_editor" style="clear:both;">
                ...
                <div class="value"><div><textarea name="bcontent" id="content"></textarea></div></div>
            </li>
        </ul>
    </div>
    <div class="online_write_button">
		<span class="online_center">
			<span class="button_pack">
                ...
                <span class="btn_input"><button type="button" class="online_lg_color02" id="link_btn"  style="cursor:pointer;font-family: NanumBarunGothic;">목록으로</button></span>
            </span>
        </span>
     </div>
	</form>
